                            ...
                            <div>
                                ...
                                <div className="mt-8 space-y-7">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <span className="block ml-3 text-base text-gray-900"> kenzi.lawson@example.com </span>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-3">
                                            <span className="block text-base text-gray-900"> (316) 555-0116 </span>
                                            <span className="block mt-1 text-base text-gray-900"> (316) 555-0116 </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
